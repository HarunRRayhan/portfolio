...
export default function Analytics({
  ...
  const setRange = (next: number) => {
    router.get('/admin/bio/analytics', { days: next }, { preserveState: true, preserveScroll: true })
  }
    ...
    <AuthenticatedLayout
      header={
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold leading-tight text-gray-800">Bio Link Analytics</h2>
      ...
      <div className="py-6 sm:py-12">
        <div className="mx-auto max-w-6xl space-y-6 px-4 sm:px-6 lg:px-8">
          ...
          <section className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
            ...
            {windowClicks === 0 ? (
              <p className="mt-6 text-sm text-gray-400">
                No clicks recorded in this window yet. Clicks are tracked from the public /bio page.
              </p>
            ) : (
              <>
          ...
          <section className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
            ...
            {byLink.length === 0 ? (
              <p className="px-5 py-6 text-sm text-gray-400">No bio links yet.</p>
            ) : (
