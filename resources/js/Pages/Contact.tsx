          ...
          <div className="container mx-auto px-4">
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                        ...
                        <CommandList>
                          ...
                          <CommandGroup>
                            {services
                              ...
                              .map((service) => (
                                <CommandItem key={service} onSelect={() => toggleService(service)}>
                                  <Check
                                    className={cn(
                                      "mr-2 h-4 w-4",
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {selectedServices.map((service) => (
                      <span key={service} className="bg-[#7C3AED] text-white px-2 py-1 rounded-full text-sm">
                        {service}
                        <button type="button" onClick={() => toggleService(service)} className="ml-2 focus:outline-none">
                          &times;
                        </button>
                      </span>
                    ))}
                ...
                <Button
                  type="submit"
                  className="bg-gradient-to-r from-[#7C3AED] to-[#6EE7B7] hover:from-[#6D28D9] hover:to-[#4ADE80] text-white font-semibold py-2 px-4 rounded-md transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50 flex items-center gap-2"
                >
