/**
 * Script to download database logos and update the DatabaseMigration component
 */
import fs from 'fs';
...
const targetDir = path.join(__dirname, 'public/images/logos/db');
...
const imagesToDownload = [
  ...
  { 
    name: 'postgresql-logo.png', 
    url: 'https://www.postgresql.org/media/img/about/press/elephant.png' 
  },
  { 
    name: 'mongodb-logo.png', 
    url: 'https://www.mongodb.com/assets/images/global/leaf.png' 
  },
  { 
    name: 'oracle-logo.png', 
    url: 'https://www.oracle.com/a/ocom/img/rh03-oracle-logo.png' 
  },
  { 
    name: 'sqlserver-logo.png', 
    url: 'https://www.microsoft.com/en-us/sql-server/img/sql-server-logo.png' 
  },
  { 
    name: 'aws-rds-logo.png', 
    url: 'https://d1.awsstatic.com/rdsImages/hp_schema%402x.b509be7f0e26575880dbd3f100d2d9fc3585ef14.png' 
  },
  { 
    name: 'gcp-logo.svg', 
  ...
  { 
    name: 'azure-logo.svg', 
    url: 'https://azurecomcdn.azureedge.net/cvt-fe62df23db878c43b28b61c1015349635dc17981d8a7e21e3958a2c0753e4957/svg/azure.svg' 
  }
];
...
function updateComponent() {
  const filePath = path.join(__dirname, 'resources/js/Pages/Services/DatabaseMigration.tsx');
  ...
  for (const image of imagesToDownload) {
    ...
    const relativePath = `/images/logos/db/${image.name}`;
