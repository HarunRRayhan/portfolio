/**
 * Script to download security tool logos and update the SecurityConsulting component
 */
import fs from 'fs';
...
const targetDir = path.join(__dirname, 'public/images/logos/security');

// List of images to download
const imagesToDownload = [
  { 
    name: 'nessus-logo.svg', 
    url: 'https://www.tenable.com/sites/drupal.dmz.tenablesecurity.com/files/images/product-images/Nessus-2020.svg' 
  },
  { 
    name: 'qualys-logo.svg', 
    url: 'https://www.qualys.com/asset/image/qualys-logo.svg' 
  },
  { 
    name: 'metasploit-logo.svg', 
    url: 'https://www.metasploit.com/includes/images/metasploit-logo.svg' 
  },
  { 
    name: 'wireshark-logo.png', 
    url: 'https://www.wireshark.org/assets/theme-2015/images/wireshark_logo.png' 
  },
  { 
    name: 'burpsuite-logo.svg', 
    url: 'https://portswigger.net/content/images/svg/icons/professional.svg' 
  },
  { 
    name: 'zap-logo.svg', 
    url: 'https://www.zaproxy.org/img/zap-logo.svg' 
  },
  { 
    name: 'snort-logo.png', 
    url: 'https://www.snort.org/assets/logo-8f4dbc9a0f1c9c8f6d3f4f7f7f7f7f7f.png' 
  },
  { 
    name: 'splunk-logo.png', 
    url: 'https://www.splunk.com/content/dam/splunk-blogs/images/2017/02/splunk-logo.png' 
  },
  { 
    name: 'kali-logo.svg', 
  ...
  { 
    name: 'aws-securityhub-logo.png', 
    url: 'https://d1.awsstatic.com/icons/console_securityhub_icon.be2b86cd1b1a41e1d1d1c0c9d42d77981413213d.png' 
  },
  { 
    name: 'azure-security-center-logo.png', 
    url: 'https://azure.microsoft.com/svghandler/security-center/?width=300&height=300' 
  }
];
...
function updateComponent() {
  const filePath = path.join(__dirname, 'resources/js/Pages/Services/SecurityConsulting.tsx');
  ...
  for (const image of imagesToDownload) {
    ...
    const relativePath = `/images/logos/security/${image.name}`;
